...
<body>
  <form action="laminator_chart.php" method="post">
    <h1 style='text-align:center'>Laminator Chart Display Page</h1>
    <p style='text-align:center'>
    <label for='THICKNESS'>Laminator Thickness Type:</label>
